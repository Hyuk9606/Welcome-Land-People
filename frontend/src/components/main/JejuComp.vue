<template>
  <div class="jejumap">
    ...
    <modal-comp v-if="showModal">
      <h3 slot="header">
        경고!
        <i class="fa-regular fa-circle-xmark closeModalBtn" @click="showModal = false"></i>
      </h3>
      <div slot="body">아무것도 입력하지않으셨습니다!</div>
      <footer slot="footer"><i class="fa-solid fa-copyright"></i>copyright</footer>
    </modal-comp>
  </div>
</template>
